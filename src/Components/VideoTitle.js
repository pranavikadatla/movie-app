...
const VideoTitle = ({title,overview}) => {
  return (
    <div className='w-screen aspect-video pt-[20%] px-12 py-2 absolute text-white bg-gradient-to-r from-black'>
        ...
        <div className='flex'>
          <div className=''>
            ...
            <button className='mx-2 my-2 text-lg p-2 px-10  bg-white rounded-md  text-black'> Play</button>
        </div>
            <button  className='mx-2 my-2  text-lg p-2 px-6 bg-gray-500 rounded-md  text-white'> More Info</button>
      </div>
